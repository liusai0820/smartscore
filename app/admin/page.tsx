...
export default async function AdminPage() {
  ...
  return (
    <div className="min-h-screen bg-[#0d1117] cloud-pattern">
      <div className="max-w-5xl mx-auto px-6 py-8">
        {/* 顶部导航 */}
        <header className="flex justify-between items-center mb-8">
          <div className="flex items-center gap-4">
            <Link href="/" className="flex items-center gap-2 text-[#6e7681] hover:text-[#a0a0a0] transition-colors">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-[#f5f1eb]" style={{ fontFamily: 'var(--font-noto-serif)' }}>
                  管理控制台
                </h1>
                <p className="text-xs text-[#6e7681]">系统配置与数据管理</p>
              </div>
            </div>
          </div>
          <Link
            href="/display"
            target="_blank"
            className="flex items-center gap-2 px-4 py-2 rounded-lg bg-[#161b22] border border-[#30363d] text-[#f5f1eb] hover:border-[#d4a853] transition-colors"
          >
            ...
            <svg className="w-3 h-3 text-[#6e7681]" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-8">
          <div className="float-card p-5 text-center group">
            ...
            <div className="text-3xl font-black text-[#f5f1eb] mb-1">{userCount}</div>
            <div className="text-[#6e7681] text-sm">评审员</div>
          </div>
          <div className="float-card p-5 text-center group">
            ...
            <div className="text-3xl font-black text-[#f5f1eb] mb-1">{projectCount}</div>
            <div className="text-[#6e7681] text-sm">参评项目</div>
          </div>
          <div className="float-card p-5 text-center group">
            ...
            <div className="text-3xl font-black text-[#f5f1eb] mb-1">{scoreCount}</div>
            <div className="text-[#6e7681] text-sm">已提交评分</div>
          </div>
        </div>
